...
import 'package:aplikacija/firebase_options.dart';
...
import 'package:aplikacija/widget/signinpages/auth_page.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return RepositoryProvider(
      ...
      child: BlocProvider(
        create: (context) => PetBloc(petRepo: context.read<PetRepository>())
          ..add(LoadSortPetsEvent()),
        child: MaterialApp(
          title: 'Flutter Demo',
          theme: ThemeData(
